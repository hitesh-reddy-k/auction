...
import { Mail, Lock, User, UserPlus, Gavel, AlertCircle, Eye, EyeOff, Check, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Join our auction platform today</p>
        </div>
          ...
          <div className="p-8">
            <div className="space-y-5">
              ...
              <div>
                ...
                />
                <p className="mt-1.5 text-xs text-slate-500">3-50 characters, will be visible to others</p>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-slate-900 placeholder-slate-400"
                  />
                  <button
                    type="button"
                ...
                {formData.password && strengthInfo && (
                  <div className="mt-2">
                    ...
                    <div className="w-full bg-slate-200 rounded-full h-1.5">
                      <div 
                        className={`h-1.5 rounded-full transition-all ${strengthInfo.color}`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 pr-12 border rounded-lg focus:ring-2 transition-all text-slate-900 placeholder-slate-400 ${
                      passwordsDontMatch 
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-300 rounded-lg hover:bg-slate-50 transition-all text-slate-700 font-medium"
                >
